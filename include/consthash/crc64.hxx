...
#pragma once
#ifndef _CONSTHASH_CRC64_HXX
#define _CONSTHASH_CRC64_HXX
...
template <size_t N>
constexpr uint64_t crc64(const char (&str)[N])
{
    return crc64(str, N - 1);
}

constexpr uint64_t crc64(std::nullptr_t)
{
    return crc64(nullptr, 0);
}
